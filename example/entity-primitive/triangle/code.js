...
const { BoundingSphere, Cartesian3, Color, ColorGeometryInstanceAttribute, ComponentDatatype, GeometryAttribute, GeometryInstance, PerInstanceColorAppearance, Primitive, PrimitiveType, Viewer } =
    window.Cesium;
...
const rawPositions = [firstVertex.x, firstVertex.y, firstVertex.z, secondVertex.x, secondVertex.y, secondVertex.z, thirdVertex.x, thirdVertex.y, thirdVertex.z];
