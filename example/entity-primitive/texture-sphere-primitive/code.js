const textureUrl = "./assets/images/wp3244114.jpg";
...
function createMaterial(url, alpha) {
    return new Cesium.Material({
        fabric: {
            ...
            components: {
                diffuse: "texture(image, fract(repeat * materialInput.st)).rgb",
                alpha: "texture(image, fract(repeat * materialInput.st)).a * alpha"
            }
        }
        //translucent : true
    });
