const { Cartesian2, Cartesian3, Color, DebugModelMatrixPrimitive, GeometryInstance, Material, MaterialAppearance, Matrix3, Matrix4, PlaneGeometry, Primitive, Transforms, VertexFormat, Viewer } =
    window.Cesium;
